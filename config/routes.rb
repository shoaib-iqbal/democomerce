Rails.application.routes.draw do
 ...
 resources :admin, only: [:index]
  ...
  match "/newsletter" ,to: "statics#news_subscriber", as: "newssubscriber", via: [:post]
  ...
  match "/careers", to: "statics#careers", as: "careers", via: [:get, :patch, :post]
  match "/policy", to: "statics#policy", as: "policy", via: [:get, :patch, :post]
