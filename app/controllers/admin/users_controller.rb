class Admin::UsersController < AdminController
  ...
  private
    ...
    def admin_user_params
      ...
      params.require(:user).permit(:name,:location,:email,:password,:password_confirmation, :popular, :delivery_time, :free_delivery ,:vendor_category_id , :role_ids,image_attributes: [:name, :avatar])
    end
    def edit_admin_user_params

      params.require(:user).permit(:name,:location,:email, :popular , :delivery_time, :free_delivery  ,:vendor_category_id, :role_ids,:avatar)
    end
end
